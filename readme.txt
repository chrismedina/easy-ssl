=== Easy SSL ===
Contributors:      Chris Medina
Tags:              SSL, easy SSL, force SSL, add ssl, enable ssl, https, seo SSL, mixed content, insecure content, secure website, website security, ssl redirect, TLS, HSTS, ssl certificate, secure socket layers
...
1. Enable HTTPS SSL and HSTS
2. Enable HTTPS using server configuration file (.htaccess or web.config) *faster option
3. Revert/Restore any server configuration changes to your original server configuration settings